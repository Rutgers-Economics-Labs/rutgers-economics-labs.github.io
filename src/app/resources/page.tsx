  ...
  return (
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Articles Section */}
        <div className="mb-16">
          <h4 className="text-2xl font-bold text-gray-900 mb-8 text-center">Articles & Papers</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
            ...
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h5 className="text-xl font-semibold text-gray-900 mb-3">Getting Census Data</h5>
              <p className="text-gray-600 mb-4">Official U.S. Census Bureau video on how to search and download census data.</p>
        ...
        <div className="mb-16">
          <h4 className="text-2xl font-bold text-gray-900 mb-8 text-center">Video Tutorials</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h5 className="text-xl font-semibold text-gray-900 mb-3">Panel Regression</h5>
              <p className="text-gray-600 mb-4">A YouTube tutorial on panel regression methods and applications.</p>
            ...
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h5 className="text-xl font-semibold text-gray-900 mb-3">Mastering Econometrics</h5>
              <p className="text-gray-600 mb-4">A YouTube playlist for mastering econometrics concepts and techniques.</p>
            ...
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h5 className="text-xl font-semibold text-gray-900 mb-3">GitHub Overview</h5>
              <p className="text-gray-600 mb-4">A beginner-friendly overview of GitHub and version control.</p>
            ...
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h5 className="text-xl font-semibold text-gray-900 mb-3">Pandas Tutorial</h5>
              <p className="text-gray-600 mb-4">A YouTube tutorial on using pandas for data analysis in Python.</p>
        ...
        {/* Tools Section */}
        <div>
          <h4 className="text-2xl font-bold text-gray-900 mb-8 text-center">Recommended Tools</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center">
            <div className="card-hover bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center mx-auto w-full max-w-xs">
