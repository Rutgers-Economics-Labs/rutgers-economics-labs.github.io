  ...
  return (
    <div className="py-20 bg-[var(--bg-secondary)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Articles Section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-8 text-center">Articles & Papers</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Introduction to Econometrics</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Data Analysis in Python</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Research Methodology</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Getting Census Data</h3>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-8 text-center">Video Tutorials</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Panel Regression</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Mastering Econometrics</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">GitHub Overview</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Pandas Tutorial</h3>
        ...
        {/* Tools Section */}
        <div>
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-8 text-center">Recommended Tools</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center">
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center mx-auto w-full max-w-xs">
              ...
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Python</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center mx-auto w-full max-w-xs">
              ...
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">R</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center mx-auto w-full max-w-xs">
              ...
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Stata</h3>
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] p-6 rounded-xl shadow-lg flex flex-col items-center text-center mx-auto w-full max-w-xs">
              ...
              <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Excel</h3>
